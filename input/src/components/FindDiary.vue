      ...
      <div class="record_server_all">
          ...
          <div v-for="diary in diarys" :key="diary.id">
              <div class="box_diary">
                  ...
                  <span class="set" @click="change_1(diary.id)">┇</span>
                  <div :class="{show:is_show,no_show:!is_show}">
...
export default {
    ...
    methods:{
        find(){
      console.log("按日期查看日记");
      axios.get('https://i5101b0918.oicp.vip/diary/findByDate',{
      params:{
              date:localStorage.getItem("data")//由该帖子返回
              },
      })
      .then((res)=>{
          console.log("成功",res); 
